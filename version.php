...
$plugin->release      = '3.1 (Build: 2016)'; // Human-friendly version name.
$plugin->requires     = 2016032400;          // This version of Moodle.
$plugin->version      = 2016040100;          // Latest build date. YYYYMMDD.
