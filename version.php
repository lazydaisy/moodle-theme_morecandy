...
$plugin->release      = '3.0 (Build: 2016)'; // Human-friendly version name.
$plugin->requires     = 2015111603.03;       // This version of Moodle 3.0
$plugin->version      = 2016040400;          // Latest build date. YYYYMMDD.
